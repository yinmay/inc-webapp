...
class Ins extends Component {
    ...
    componentDidMount() {
        ...
        this.props.getPlayerSocialTrending({
            ...
            var myChart = echarts.init(document.getElementById('bar-ins'));
            // 绘制图表
            myChart.setOption({
                tooltip: {
                    trigger: 'axis',
    ...
    render() {
        ...
        return (
            <div style={{width:320,height:200,display:'flex',alignItems:'center',justifyContent:'center'}}>
                <div id="ins-chart" >
                    <div id="bar-ins" style={{ width: 300, height: 200, marginTop: 40 }}>
                    </div>
...
const mapStateToProps = (state) => {
  ...
  const Insbar =  withRouter(connect(mapStateToProps, mapDispatchToProps)(Ins))
  export default Insbar
